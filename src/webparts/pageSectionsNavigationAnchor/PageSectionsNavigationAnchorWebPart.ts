...
import PageSectionsNavigationAnchor from './components/PageSectionsNavigationAnchor';
import { IPageSectionsNavigationAnchorProps } from './components/IPageSectionsNavigationAnchorProps';
...
export default class PageSectionsNavigationAnchorWebPart extends BaseClientSideWebPart<IPageSectionsNavigationAnchorWebPartProps> {
