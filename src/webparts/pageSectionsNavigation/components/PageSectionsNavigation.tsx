...
import { IPageSectionsNavigationProps } from './IPageSectionsNavigationProps';
...
export default class PageSectionsNavigation extends React.Component<IPageSectionsNavigationProps, IPageSectionsNavigationState> {
